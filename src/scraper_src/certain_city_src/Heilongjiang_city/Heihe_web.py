...
if __name__ == '__main__':
    ...
    data_dict = {'searchWord': '%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F%20%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0',
                 'siteCode': '2311000001', 'column': '%E5%85%A8%E9%83%A8', 'pageSize': '10',
                 'pageNum': '1', 'checkHandle': '1', 'searchSource': '0', 'govWorkBean': '%7B%7D',
                 'countKey': '0', 'uc': '0', 'left_right_index=': '0', 'orderBy': '0', 'timeStamp': '0',
                 'wordPlace': '1'}
