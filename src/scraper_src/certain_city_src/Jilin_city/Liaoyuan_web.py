...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Liaoyuan',
                 'province': 'Jilin',
                 'total_news_num': 331,
                 'each_page_num': 8,
                 'targeted_year': 2019,
                 'base_url': 'http://111.26.144.5:8080/was5/web/search?page={page_num}&channelid=262221&searchword=doccontent'
                             '%3D%27%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0%27&keyword=doccontent%3D%27%E8%80%83%E5%AF'
                             '%9F%E5%AD%A6%E4%B9%A0%27&perpage=8&outlinepage=10'
                 }
    # 可选参数
    thread_num = 5

    """xpath信息"""
    frames_xpath = 'x://*[@id="tab1"]/div/div/ul//li'
    title_xpath = 'x://a'
    url_path = None
    date_xpath = ['x://span[2]']
