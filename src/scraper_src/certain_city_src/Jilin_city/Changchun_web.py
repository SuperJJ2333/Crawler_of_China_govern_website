...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Changchun',
                 'province': 'Jilin',
                 'total_news_num': 82,
                 'each_page_num': 10,
                 'targeted_year': 2019,
                 'base_url': 'http://intellsearch.changchun.gov.cn/was5/web/search?page={page_num}&channelid=291010&searchword'
                             '=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F+%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&keyword=%E5'
                             '%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F+%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&orderby'
                             '=-DOCRELTIME&StringEncoding=UTF-8&perpage=10&outlinepage=10&searchscope=&timescope'
                             '=&timescopecolumn=&orderby=-DOCRELTIME&andsen=&total=&orsen=&exclude='
                 }
    # 可选参数
    thread_num = 5

    """xpath信息"""
    frames_xpath = 'x:/html/body/div[4]/div[2]/div/div[2]/div[2]/div/dl'
    title_xpath = 'x://dt/a'
    date_xpath = ['x://dt/span']
    ...
    city_info.fetch_web_by_requests(request_type='get_xpath', is_begin_from_zero=True)
