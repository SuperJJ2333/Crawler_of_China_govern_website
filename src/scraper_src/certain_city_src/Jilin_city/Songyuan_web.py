...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Songyuan',
                 'province': 'Jilin',
                 'total_news_num': 342,
                 'each_page_num': 10,
                 'targeted_year': 2019,
                 'base_url': 'https://search.jlsy.gov.cn/search/tabsearch/pageNews?currPage={page_num}&q=%E5%AD%A6%E4%B9%A0%E8'
                             '%80%83%E5%AF%9F+%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&py=1&param=start%3D2018-01-01'
                             '%2Cend%3D2018-12-31%2Call%2Cvague'
                 }
    # 可选参数
    thread_num = 5

    """xpath信息"""
    frames_xpath = 'x://ul/li'
    title_xpath = 'x://a'
    url_path = None
    date_xpath = ['x://span']
