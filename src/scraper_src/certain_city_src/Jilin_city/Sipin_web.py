...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Sipin',
                 'province': 'Jilin',
                 'total_news_num': 457,
                 'each_page_num': 7,
                 'targeted_year': 2019,
                 'base_url': 'http://58.244.255.84:8080/was5/web/search?page={page_num}&channelid=221156&searchword=%E8%80%83'
                             '%E5%AF%9F%E5%AD%A6%E4%B9%A0&keyword=%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&perpage=7'
                             '&outlinepage=10'
                 }
    # 可选参数
    thread_num = 5
    ...
    """xpath信息"""
    frames_xpath = 'x://*[@id="cd01"]/ul/li'
    title_xpath = 'x://h3/a[1]'
    url_path = None
    date_xpath = ['x://h3[2]/span/i',
                  'x://a/h3/span/i']
