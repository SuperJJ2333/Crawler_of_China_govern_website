...
if __name__ == '__main__':
    ...
    city_info = {'name': 'Wuxi',
                 ...
                 'each_page_num': 15,
                 'targeted_year': 2019,
                 'base_url': 'https://www.wuxi.gov.cn/search/index.html?siteId=168&siteName=%E6%97%A0%E9%94%A1%E5%B8%82%E4%BA%BA%E6%B0%91%E6%94%BF%E5%BA%9C&keyword=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F'
                 }
    # 可选参数
    thread_num = 5

    """post信息"""
    data_dict = {'siteName': '无锡市人民政府', 'searchType': 'fullSearch',
                 'keyword': '学习考察 考察学习', 'isLocalWebSite': 'true', 'siteId': '168',
                 'channel': 'all', 'timeCondition': 'setTime',
                 'dateRange': '2018-01-01T00:00:00Z|2018-12-31T23:59:59Z',
                 'sortType': 'smartSort', 'page': '3'}
    ...
    headers = {
        ...
        "Host": "www.wuxi.gov.cn",
        "Origin": "https://www.wuxi.gov.cn",
        "Referer": "https://www.wuxi.gov.cn/search/index.html?siteId=168&siteName=%E6%97%A0%E9%94%A1%E5%B8%82%E4%BA%BA%E6%B0%91%E6%94%BF%E5%BA%9C&keyword=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F",
