...
if __name__ == '__main__':
    ...
    name = 'Anyang'
    province = 'Henan'
    url = 'https://searchapi.anyang.gov.cn/open/api/external?keywords=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F&siteId' \
          '=4550000372&allKeyword=&anyKeyword=&noKeyword=&searchRange=-1000&sortType=150&beginTime=2017-01-01&endTime' \
          '=2017-12-31&pageNumber={page_num}&pageSize=15&fileType=0&docType=0'
    ...
    city_info = PageMother(name=name, url=url, targeted_year=time_limit, total_news_num=total_news_num,
                           each_page_num=each_page_num, province=province, is_headless=False)

    city_info.fetch_web_multiple(listen_target=listen_path, cleaned_method=extract_news_info,
                                 is_by_listen=True)
