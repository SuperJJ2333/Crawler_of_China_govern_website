...
if __name__ == '__main__':
    ...
    """post信息"""
    data_dict = {'key': '考察学习', 'depid': '0', 'sourcefrom': 'ALL', 'interval': 'ALL',
                 'sortrule': 'PUBDATE', 'searchtype': 'CONTENT', 'page': '3'}
    ...
    """xpath信息"""
    frames_xpath = 'x://*[@id="main"]/div/div[2]/div[1]/div'
    title_xpath = 'x://div[1]/a'
    date_xpath = ['x://div[2]/span', 'x://div[3]/span']
    ...
    city_info.fetch_web_by_requests(request_type='post_xpath',
