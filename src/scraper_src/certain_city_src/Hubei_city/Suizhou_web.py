...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Suizhou',
                 'province': 'Hubei',
                 'total_news_num': 247,
                 'each_page_num': 20,
                 'targeted_year': 2019,
                 'base_url': f'http://www.suizhou.gov.cn/ssp/search/api/search?time={int(time.time() * 1000)}'
                 }
    # 可选参数
    thread_num = 5

    """post信息"""
    data_dict = {'siteType': '1', 'mainSiteId': 'ff8080818bd0e0db018bd1839c460001',
                 'siteId': 'ff8080818bd0e0db018bd1839c460001',
                 'depSiteId': 'ff8080818bd0e0db018bd1839c460001', 'type': '2', 'page': '2',
                 'rows': '20', 'historyId': 'ff8080818e0daf15018f7f968334398c',
                 'sourceType': 'SSP_ZHSS', 'isChange': '0', 'fullKey': 'N',
                 'wbServiceType': '13', 'startDate': '2018-01-01', 'endDate': '2018-12-31',
                 'sortFiled': 'RELEVANCE', 'keyWord': '学习考察 考察学习', 'isProvince': '1'}
