...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Deyang',
                 'province': 'Sichuan_city',
                 'total_news_num': 165822,
                 'each_page_num': 20,
                 'targeted_year': 2019,
                 'base_url': 'https://www.deyang.gov.cn/search/searchNew.jsp?q=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F'
                             '+%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&siteId=&t_id=54&type=&class=0&p={page_num}'
                 }
    # 可选参数
    thread_num = 5

    """xpath信息"""
    frames_xpath = 'x://body/div[2]/div[1]/div[2]/div[1]/div[2]/div'
    title_xpath = 'x://h1/a'
