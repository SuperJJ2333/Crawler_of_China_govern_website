...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Yueshan',
                 'province': 'Sichuan_city',
                 'total_news_num': 161,
                 'each_page_num': 20,
                 'targeted_year': 2020,
                 'base_url': 'https://www.leshan.gov.cn/ls/s?qt=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F+%E8%80%83%E5%AF'
                             '%9F%E5%AD%A6%E4%B9%A0&sq=&pageSize=20&ot=xgd&st=2019-01-01&et=2019-12-31&sit=3&t=&page'
                             '={page_num}'
                 }
    # 可选参数
    thread_num = 5
    ...
    """xpath信息"""
    frames_xpath = 'x://body/div[1]/div[2]/div[3]/ul/li'
    title_xpath = 'x://h1/a'
