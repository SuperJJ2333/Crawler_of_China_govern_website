...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Bazhong',
                 'province': 'Sichuan_city',
                 'total_news_num': 263,
                 'each_page_num': 10,
                 'targeted_year': 2019,
                 'base_url': 'https://www.cnbz.gov.cn/site/tpl/6780041?isAllSite=true&platformCode=&siteId=&columnId'
                             '=&columnIds=&typeCode=&beginDate=2018-01-01&endDate=2018-12-31&fromCode=&keywords=%E8'
                             '%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0+%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F&oldKeywords'
                             '=&subkeywords=&excColumns=&datecode=&sort=desc&type=&tableColumnId=&indexNum=&fileNum'
                             '=&pid=&flag=false&orderType=1&pageIndex={page_num}&pageSize=10'
                 }
    # 可选参数
    thread_num = 5
