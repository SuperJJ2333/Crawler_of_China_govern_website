...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Yibing',
                 'province': 'Sichuan_city',
                 'total_news_num': 10004,
                 'each_page_num': 10,
                 'targeted_year': 2022,
                 'base_url': 'https://www.yibin.gov.cn/irs/front/search'
                 }
    # 可选参数
    thread_num = 5

    """post信息"""
    data_dict = {"tenantId": 202, "searchWord": "学习考察 考察学习", "dataTypeId": 2342,
                 "historySearchWords": ["民生", "文件库", "公积金", "李庄古镇", "政府工作报告", "购房补贴", "一蓝一绿",
                                        "成渝地区双城经济圈", "三江新区", "现代化区域中心城市"], "orderBy": "related",
                 "searchBy": "all", "pageNo": 2, "pageSize": 10, "filters": [], "configTenantId": 202,
                 "customFilter": {"operator": "and", "properties": [], "filters": []}, "granularity": "ALL",
                 "sign": "fb3d82fb-7ad9-4aff-f2af-b6a722298b36"}
