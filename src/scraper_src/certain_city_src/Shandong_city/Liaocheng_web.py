...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Liaocheng',
                 'province': 'Shandong_city',
                 'total_news_num': 2543,
                 'each_page_num': 10,
                 'targeted_year': 2018,
                 'base_url': 'http://www.liaocheng.gov.cn/search.html?keyword=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F%E8'
                             '%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&type=1&timeing=%E5%85%A8%E9%83%A8%E6%97%B6%E9%97%B4'
                             '&startDate=1483228800000&endDate=1514678400000&page={page_num}'
                 }
    # 可选参数
    thread_num = 5

    """xpath信息"""
    frames_xpath = 'x://*[@id="barrierfree_container"]/div[4]/div[2]/div/div[3]/ul/li'
    title_xpath = 'x://div/div[1]/a[1]'
    date_xpath = ['x://div/div[2]/span[2]']
