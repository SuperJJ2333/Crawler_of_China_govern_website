...
if __name__ == '__main__':
    ...
    headers = {"Accept":"application/json, text/plain, */*","Accept-Encoding":"gzip, deflate, br, zstd","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Connection":"keep-alive","Cookie":"Path=/; _trs_uv=lye9nw3g_4643_hl81; security_session_verify=3e6e91c70a596ecc509ecb5f6b622cd2; _trs_ua_s_1=lyrkpzhe_4643_7lc4","Host":"www.nmg.gov.cn","Referer":"https://www.nmg.gov.cn/nmg_search/","Sec-Fetch-Dest":"empty","Sec-Fetch-Mode":"cors","Sec-Fetch-Site":"same-origin","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0","sec-ch-ua":"\"Not/A)Brand\";v=\"8\", \"Chromium\";v=\"126\", \"Microsoft Edge\";v=\"126\"","sec-ch-ua-mobile":"?0","sec-ch-ua-platform":"\"Windows\""}
    ...
    scraper = Scraper(city_info, method='get', data_type='json',
                      ...
                      is_by_requests=True, verify=False, proxies=fiddler_proxies)
