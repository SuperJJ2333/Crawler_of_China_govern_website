...
if __name__ == '__main__':
    ...
    city_info = {
        ...
        'province_name': '安徽省',
        'province': 'Anhui',
        'base_url': 'https://www.fy.gov.cn/index.php?c=search&site_id=543740479a05c26f4be2861a&type=&keywords=%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&sort=&forceSearch=&wrongSearch=&page={page_num}',
