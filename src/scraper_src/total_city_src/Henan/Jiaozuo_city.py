...
if __name__ == '__main__':
    ...
    post_data = {'q': '学习考察 考察学习', 'catalogId': '', 'type': '', 'allWord': '', 'noWord': '', 'timeType': '', 'sort': '', 'order': '', 'forCatalogType': '0', 'token4': 'c0794e07aea742eaa9ab954f3f670a7f', 'siteId': '', 'offset': '16', 'limit': '8', 'infoType': ''}
