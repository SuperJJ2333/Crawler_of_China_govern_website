...
def extract_news_info(data_list, page_num, logger):
    data_list = data_list.replace('jQuery17105788639335064554_1721115083113(', '').replace(')', '')
...
if __name__ == '__main__':
    ...
    city_info = {
        ...
        'base_url': 'https://so.ankang.gov.cn/Views/searchkjsonp.cshtml?callback=jQuery17105788639335064554_1721115083113&m=&t=0&sid=0&q=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F+%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&pageIndex={page_num}&pageSize=20&fullTextType=0&day=&date=&cycle=0&beginDate=&endDate=&year=0&articleNumber=&theme=0&service=0&valid=&weight=1',
        'total_news_num': 671,
        'each_page_news_num': 20,
    }

    headers = {"Accept":"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript, */*; q=0.01","Accept-Encoding":"gzip, deflate, br, zstd","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Connection":"keep-alive","Cookie":"Hm_lvt_f79ed174397504cdc42cb2199a06fa8e=1720118181; ASP.NET_SessionId=vg3g5mpmzkmdlsqlyprpqycl; arialoadData=false","Host":"so.ankang.gov.cn","Referer":"https://so.ankang.gov.cn/s","Sec-Fetch-Dest":"empty","Sec-Fetch-Mode":"cors","Sec-Fetch-Site":"same-origin","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0","X-Requested-With":"XMLHttpRequest","sec-ch-ua":"\"Not/A)Brand\";v=\"8\", \"Chromium\";v=\"126\", \"Microsoft Edge\";v=\"126\"","sec-ch-ua-mobile":"?0","sec-ch-ua-platform":"\"Windows\""}
    fiddler_proxies = {
