...
if __name__ == '__main__':
    ...
    city_info = {
        ...
        'base_url': 'https://www.hegang.gov.cn/search5/search/s',

        'total_news_num': 316,
        'each_page_news_num': 10,
    }

    headers = {"Accept":"*/*","Accept-Encoding":"gzip, deflate, br, zstd","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","Cookie":"Path=/; Path=/; JSESSIONID=25F8D567B8DEA3ABA04B798D06756EAF; arialoadData=false; 2304000002=5a2m5Lmg6ICD5a+fIOiAg+Wvn+WtpuS5oA==","Host":"www.hegang.gov.cn","Origin":"https://www.hegang.gov.cn","Sec-Fetch-Dest":"empty","Sec-Fetch-Mode":"cors","Sec-Fetch-Site":"same-origin","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0","X-Requested-With":"XMLHttpRequest","sec-ch-ua":"\"Not/A)Brand\";v=\"8\", \"Chromium\";v=\"126\", \"Microsoft Edge\";v=\"126\"","sec-ch-ua-mobile":"?0","sec-ch-ua-platform":"\"Windows\""}
