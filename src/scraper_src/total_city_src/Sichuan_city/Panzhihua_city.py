...
if __name__ == '__main__':
    ...
    post_data = {'searchType': 'onlyTitle', 'keyword': '学习考察 考察学习', 'isLocalWebSite': 'false', 'siteId': '14', 'channel': 'all', 'timeCondition': 'unlimitedTime', 'dateRange': '', 'queryFilter': '', 'sortType': 'timeSort', 'page': '4'}
