...
if __name__ == '__main__':
    ...
    post_data = '{"code":"17da70961a7","historySearchWords":["学习考察 考察学习","学习考察","考察学习"],"dataTypeId":"107","orderBy":"related","searchBy":"title","appendixType":"","granularity":"ALL","trackTotalHits":true,"beginDateTime":"","endDateTime":"","isSearchForced":0,"filters":[],"pageNo":3,"pageSize":10,"customFilter":{"operator":"and","properties":[]},"searchWord":"学习考察 考察学习"}'
