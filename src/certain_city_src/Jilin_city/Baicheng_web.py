...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Baicheng',
                 'province': 'Jilin',
                 'total_news_num': 101,
                 'each_page_num': 10,
                 'targeted_year': 2019,
                 'base_url': 'http://139.209.204.132:8080/was5/web/search?page={page_num}&channelid=218016&searchword=%E5%AD'
                             '%A6%E4%B9%A0%E8%80%83%E5%AF%9F&keyword=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F'
                             '&StringEncoding=UTF-8&perpage=10&outlinepage=10'
                 }
    # 可选参数
    thread_num = 5

    """xpath信息"""
    frames_xpath = 'x://*[@id="zoom"]/ul/li'
    title_xpath = 'x://a'
    url_path = None
    date_xpath = ['x://span']
