...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Jilin',
                 'province': 'Jilin',
                 'total_news_num': 117,
                 'each_page_num': 10,
                 'targeted_year': 2019,
                 'base_url': 'http://122.137.242.29:8083/was5/web/search?page={page_num}&channelid=233474&searchword=%E8%80%83'
                             '%E5%AF%9F%E5%AD%A6%E4%B9%A0&keyword=%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&perpage=10'
                             '&outlinepage=10'
                 }
    # 可选参数
    thread_num = 5
    ...
    """xpath信息"""
    frames_xpath = 'x://*[@id="app"]/div[5]/div/div/ul/li'
    title_xpath = 'x://a/div/div[1]'
    url_path = 'x://a'
    date_xpath = ['x://a/div[1]/div[2]']
