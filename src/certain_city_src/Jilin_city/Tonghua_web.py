...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Tonghua',
                 'province': 'Jilin',
                 'total_news_num': 38,
                 'each_page_num': 8,
                 'targeted_year': 2019,
                 'base_url': 'http://139.215.208.12:8091/was5/web/search?page={page_num}&channelid=287612&searchword=%E8%80%83'
                             '%E5%AF%9F%E5%AD%A6%E4%B9%A0&keyword=%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&perpage=12'
                             '&outlinepage=10'
                 }
    # 可选参数
    thread_num = 5
