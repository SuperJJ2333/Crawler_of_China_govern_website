...
if __name__ == '__main__':
    ...
    city_info = {'name': 'Tonghua',
                 ...
                 'each_page_num': 10,
                 'targeted_year': 2019,
                 'base_url': 'http://122.143.195.10:8080//was5/web/search?page=2&channelid=267646&searchword=%E5%AD'
                             '%A6%E4%B9%A0%E8%80%83%E5%AF%9F&keyword=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F&perpage=10'
                             '&outlinepage=10'
                 }
    # 可选参数
    thread_num = 5
    ...
    """xpath信息"""
    frames_xpath = 'x://*[@id="tab1"]/div[1]/div[2]/ul/li'
    title_xpath = 'x://a'
    url_path = None
    date_xpath = ['x://span[2]']
