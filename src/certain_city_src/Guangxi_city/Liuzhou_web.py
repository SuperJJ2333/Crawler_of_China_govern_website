...
if __name__ == '__main__':
    ...
    """post信息"""
    data_dict = {"code": "18801b40549", "configCode": "", "codes": "", "searchWord": "学习考察",
                 "historySearchWords": ["学习考察", "学习考察 考察学习"], "dataTypeId": "1", "orderBy": "related",
                 "searchBy": "all", "appendixType": "", "granularity": "CUSTOM", "beginDateTime": 1514736000000,
                 "endDateTime": 1546271999999, "isSearchForced": 0, "filters": [], "pageNo": 2, "pageSize": 10}
