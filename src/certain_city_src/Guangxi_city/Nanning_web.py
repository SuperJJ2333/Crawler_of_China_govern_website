...
def extract_news_info(json_data, year, page_num, logger, base_url=None):
    ...
    if 'resultDocs' in data:
        ...
        for news_item in data_list:
            ...
            try:
                # 提取发布日期
                date = datetime.fromtimestamp(news_item['timestamp']/1000).strftime('%Y-%m-%d')

                news_info = news_item['data']
                # 提取新闻标题
...
if __name__ == '__main__':
    ...
    """post信息"""
    data_dict = {'keyPlace': '0', 'sort': 'relevance', 'startDateStr': '2018-01-01',
                 'timeOption': '2', 'endDateStr': '2018-12-31',
                 'locationCode': '450000000000', 'siteCode': '4501000060',
                 'tab': 'all', 'page': '2', 'pageSize': '20', 'qt': '学习考察',
                 'ie': '1b42e940-094e-4f7e-8f4a-8ef7f1eb0094'}
