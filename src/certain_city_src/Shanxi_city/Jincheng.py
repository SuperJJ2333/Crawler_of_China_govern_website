...
if __name__ == '__main__':
    ...
    city_info = {'name': 'Jincheng',
                 ...
                 'each_page_num': 10,
                 'targeted_year': 2019,
                 'base_url': 'https://www.jcgov.gov.cn/trssearch/v2/searchAll.do?siteId=13&searchTag=all&allKeywords'
                             '=%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&fullKeywords=&orKeywords=&notKeywords=&sort'
                             '=&position=0&startTime=2018-01-01&endTime=2018-12-31&organization=&pageNum={page_num}&pageSize'
  ...
  "Cookie": "_trs_uv=lwammxvq_335_ib3z; arialoadData=true; ariawapChangeViewPort=true",
  "Host": "www.jcgov.gov.cn",
  "Referer": "https://www.jcgov.gov.cn/search/",
