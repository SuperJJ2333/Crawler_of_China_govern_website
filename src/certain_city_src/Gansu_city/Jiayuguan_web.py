    ...
    if 'data' in data:
        ...
        for news_item in data_list:
            ...
            try:
                ...
                # 提取发布日期
                date = soup.find('div', class_='sourceTime').find_all('span')[1].text.replace('时间:', '').strip()
...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Jiayuguan',
                 'province': 'Gansu',
                 'total_news_num': 144,
                 'each_page_num': 15,
                 'targeted_year': 2020,
                 'base_url': 'https://jyg.gov.cn/api-gateway/jpaas-jsearch-web-server/interface/search/info?websiteid=&q=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F%20%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&pg=&cateid=891f65c014ab497ea1b818c2b4787c79&serviceId=479df5cc04d64205b5854f300e2b4ae8&p={page_num}&begin=2019-01-01&end=2019-12-31'
