    ...
    if 'result' in data:
        ...
        for news_item in data_list:
            ...
            try:
                ...
                title = soup.find('a', href=True).text

                # 提取新闻URL
                news_url = soup.find('a', href=True)['href']
                # news_url = news_url.split('url=')[1].split('&')[0]
...
if __name__ == '__main__':
    ...
    """post信息"""
    data_dict = {'websiteid': '620600000000000', 'q': '学习考察 学习考察',
                 'p': '1', 'pg': '5', 'cateid': '2', 'begin': '20190101',
                 'end': '20191231', 'tpl': '5'}
    ...
    city_info.fetch_web_by_requests(request_type='post_session', cleaned_method=extract_news_info,
                                    data_dict=data_dict, page_num_name=page_num_name, base_url=base_url,)
