...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Qingyang',
                 'province': 'Gansu',
                 'total_news_num': 71,
                 'each_page_num': 10,
                 'targeted_year': 2020,
                 'base_url': 'https://www.zgqingyang.gov.cn/s?wd=%e8%80%83%e5%af%9f%e5%ad%a6%e4%b9%a0%20%e5%ad%a6%e4'
                             '%b9%a0%e8%80%83%e5%af%9f&tt=5&bt=2019-01-01&et=2019-12-31&kp=0&st=2&siid=1&sid=0&p={page_num}&vc='
                 }
    # 可选参数
    thread_num = 5
