...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Nantong',
                 'province': 'Jiangsu',
                 'total_news_num': 222,
                 'each_page_num': 10,
                 'targeted_year': 2017,
                 'base_url': 'https://www.nantong.gov.cn/TrueSearch/search/getResult'
                 }
    # 可选参数
    thread_num = 5
    ...
    """post信息"""
    # 将JSON字符串转换成字典
    data_dict = {'msg_title': '考察学习', 'siteId': '1f9dcfb8-d52d-46e6-83e7-479a46f2f74b',
                 'indexModel': 'msgnews,msgxxgk,msghdjl,bsfwnew', 'fileType': 'htm',
                 'order': 'time', 'searchStarttime': '1451606400000',
                 'searchEndtime': '1483142400000', 'pageIndex': '1', 'pageSize': '10'}
    ...
    headers = {
        ...
        "Cookie": "__jsluid_s=4d4ac738bf7b6969a0efb35377aa908a; SF_cookie_3=59475340; zh_choose=n",
        "Host": "www.nantong.gov.cn",
        "Origin": "https://www.nantong.gov.cn",
        "Referer": "https://www.nantong.gov.cn/xssym/xssym.html?sf=0&btitle=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F",
