...
def extract_news_info(json_data, year, page_num, logger, base_url=None):
    ...
    if 'result' in data:
        ...
        for news_item in data_list:
            ...
            # 提取新闻标题
            title = soup.find('div', class_='jcse-news-title').a.get_text(strip=True)

            # 提取 URL
            news_url = soup.find('div', class_='jcse-news-title').a['href']
...
if __name__ == '__main__':
    ...
    """post信息"""
    data_dict = {'websiteid': '370600000000000', 'q': '学习考察 考察学习', 'p': '1',
                 'pg': '20', 'cateid': '5',
                 'begin': '20170101', 'end': '20171231', 'tpl': '82'}
    page_num_name = 'p'
    # off_set = 5
