...
def extract_news_info(json_data, year, page_num, logger, base_url=None):
    ...
    if 'result' in data:
        ...
        for news_item in data_list:
            ...
            try:
                # 寻找新闻标题和 URL
                news_block = soup.find('div', class_='jcse-news-title')
                ...
                # 寻找发布日期
                date = news_block.find_next_sibling('div').find('span', class_='jcse-news-date').text.strip()
...
if __name__ == '__main__':
    ...
    """post信息"""
    data_dict = {'websiteid': '371600000000000', 'q': '学习考察', 'p': '1', 'pg': '10',
                 'begin': '201711',
                 'end': '20171231',
                 'cateid': '15763',
    ...
    page_num_name = 'p'
    # off_set = 5
    base_url = 'http://www.binzhou.gov.cn/jsearchfront/'
