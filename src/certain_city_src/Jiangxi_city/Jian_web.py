...
if __name__ == '__main__':
    ...
    city_info = {'name': 'Jian',
                 ...
                 'each_page_num': 20,
                 'targeted_year': 2020,
                 'base_url': 'https://www.jian.gov.cn/index.php?c=api&m=essearchlist&inputorder=1&keyword=%E5%AD%A6'
                             '%E4%B9%A0%E8%80%83%E5%AF%9F&messagetype=&siteid=&size=20&time=all&page={page_num}'
                 }
    # 可选参数
    thread_num = 5
...
#                  'cateid': '118', 'begin': '20200101', 'end': '20201231', 'tpl': '8'}
#
#     page_num_name = "p"
#     # off_set = 10
