...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Guangan',
                 'province': 'Sichuan_city',
                 'total_news_num': 33,
                 'each_page_num': 20,
                 'targeted_year': 2020,
                 'base_url': 'https://www.guang-an.gov.cn/search4/s?searchWord=%25E5%25AD%25A6%25E4%25B9%25A0%25E8'
                             '%2580%2583%25E5%25AF%259F%2520%25E8%2580%2583%25E5%25AF%259F%25E5%25AD%25A6%25E4%25B9'
                             '%25A0&column=%25E5%2585%25A8%25E9%2583%25A8&pageSize=10&pageNum={page_num}&siteCode=5116000002'
                             ...
                             '&orderBy=0&startTime=2019-01-01%2000:00:00&endTime=2019-12-31%2023:59:59&timeStamp=5'
    ...
    """xpath信息"""
    frames_xpath = 'x://body/div[2]/div/div[2]/div'
    title_xpath = 'x://div[1]/a'
    date_xpath = ['x://div/div/p[2]/span',
                  'x://div[2]/div/p[1]/span']
