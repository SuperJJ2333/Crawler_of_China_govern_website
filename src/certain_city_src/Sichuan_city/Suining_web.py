...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Suining',
                 'province': 'Sichuan_city',
                 'total_news_num': 126945,
                 'each_page_num': 10,
                 'targeted_year': 2019,
                 'base_url': 'https://www.suining.gov.cn/search.html?q=%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&content=1'
                             '&content=1&page={page_num}'
                 }
    # 可选参数
    thread_num = 5

    """xpath信息"""
    frames_xpath = 'x://body/main/div/div/div[1]/section[4]/a'
    title_xpath = 'x:..//a'
    date_xpath = ['x://div[3]/text()']
