...
if __name__ == '__main__':
    ...
    # 爬虫基本信息
    city_info = {'name': 'Xiaogan',
                 'province': 'Hubei',
                 'total_news_num': 51274,
                 'each_page_num': 10,
                 'targeted_year': 2019,
                 'base_url': 'https://www.xiaogan.gov.cn/search_{page_num}.jspx?q=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F+%E8%80'
                             '%83%E5%AF%9F%E5%AD%A6%E4%B9%A0'
                 }
    # 可选参数
    thread_num = 5
