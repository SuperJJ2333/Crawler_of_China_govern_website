...
if __name__ == '__main__':
    ...
    data_dict = {'searchWord': '%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F%20%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0',
                 'siteCode': '2302000004', 'column': '%E5%85%A8%E9%83%A8', 'pageSize': '10',
                 'pageNum': '0', 'checkHandle': '1', 'searchSource': '0', 'areaSearchFlag': '0',
                 'countKey': '0', 'uc': '0', 'left_right_index=': '0', 'orderBy': '0',
                 'startTime': '2019-01-01 00:00:00', 'endTime': '2019-12-31 23:59:59',
                 'timeStamp': '5', 'wordPlace': '0'}
    ...
    headers = {
        ...
        "Origin": "https://www.qqhr.gov.cn",
        "Sec-Fetch-Site": "same-origin",
        "Sec-Fetch-Mode": "cors",
        "Sec-Fetch-Dest": "empty",
        "Accept-Encoding": "gzip, deflate, br, zstd",
        "Accept-Language": "zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6",
        "Cookie": "SESSION_WEB_CACHE_KEY=96350bacb6b84d139bb95015f1060771; arialoadData=true; ariawapChangeViewPort=true; mozi-assist={%22show%22:false%2C%22audio%22:false%2C%22speed%22:%22middle%22%2C%22zomm%22:1%2C%22cursor%22:false%2C%22pointer%22:false%2C%22bigtext%22:false%2C%22overead%22:false}; 2302000004=5a2m5Lmg6ICD5a+fIOiAg+Wvn+WtpuS5oCzlrabkuaDogIPlr58="
    }
    """get信息"""
