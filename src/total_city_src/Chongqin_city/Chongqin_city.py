...
if __name__ == '__main__':
    ...
    post_data = '{"id":"7","tenantId":7,"searchWord":"学习考察","dataTypeId":"7","pageNo":1,"pageSize":10,"orderBy":"related","searchBy":"title","appendixType":"","granularity":"ALL","beginDateTime":"","endDateTime":"","isSearchForced":0,"filters":[],"sign":"791435a1-6ea7-41f5-a167-74b2a775967a","pager":{},"searchInfo":{},"dataTypes":[],"configTenantId":"7","historySearchWords":["学习考察","学习考察 考察学习"],"operationType":"search","seniorBox":0,"isDefaultAdvanced":0,"isAdvancedSearch":0,"advancedFilters":[],"customFilters":[],"areaCode":""}'
