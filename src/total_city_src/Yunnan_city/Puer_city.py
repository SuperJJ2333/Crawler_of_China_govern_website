...
if __name__ == '__main__':
    ...
    post_data = r'{"aliasName":"article_data,open_data,mailbox_data,guest_book","keyWord":"学习考察 考察学习","lastkeyWord":"学习考察 考察学习","searchKeyWord":false,"orderType":"score","searchType":"text","searchScope":"1","searchOperator":0,"searchDateType":"","searchDateName":"time.any_time","beginDate":"","endDate":"2024-07-05","language":"chinese","showId":"35ede40151f31c8873ed450acc7a93b3","auditing":["1","5"],"owner":"1948729862","token":"tourist","urlPrefix":"/aop_component/","page":{"current":2,"size":10,"pageSizes":[2,5,10,20,50,100],"total":42,"totalPage":5,"indexs":[1,2,3,4,5]},"advance":false,"advanceKeyWord":"","lang":"i18n_zh_CN"}'
