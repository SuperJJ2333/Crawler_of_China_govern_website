...
if __name__ == '__main__':
    ...
    post_data = r'{"aliasName":"article_data,open_data,mailbox_data,guest_book","keyWord":"学习考察 考察学习","lastkeyWord":"学习考察 考察学习","searchKeyWord":false,"orderType":"score","searchType":"text","searchScope":"1","searchOperator":0,"searchDateType":"","searchDateName":"time.any_time","beginDate":"","endDate":"2024-07-05","showId":"f8d03086e1bc3b9c9f3bc4040d99a900","auditing":["1"],"owner":"1785431013","token":"\n\n\n\n\n\n\n\n\n\n\ntourist\n","urlPrefix":"/aop_component/","page":{"current":2,"size":10,"pageSizes":[2,5,10,20,50,100],"total":84,"totalPage":9,"indexs":[1,2,3,4,5,6,7,8,9]},"advance":false,"advanceKeyWord":"","lang":"i18n_zh_CN"}'
