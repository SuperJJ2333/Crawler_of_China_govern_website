...
if __name__ == '__main__':
    ...
    city_info = {
        ...
        'province_name': '甘肃省',
        'province': 'Gansu',
        'base_url': 'https://www.jyg.gov.cn/api-gateway/jpaas-jsearch-web-server/interface/search/info?websiteid=&q=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F%20%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&pg=&cateid=891f65c014ab497ea1b818c2b4787c79&serviceId=479df5cc04d64205b5854f300e2b4ae8&p={page_num}&pos=title',
        'total_news_num': 66,
