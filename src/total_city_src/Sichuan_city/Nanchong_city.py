...
if __name__ == '__main__':
    ...
    post_data = '{"tenantId":2,"searchWord":"学习考察 考察学习","dataTypeId":22,"historySearchWords":["建党100周年","经济建设","人文南充","新村新貌","投资南充"],"orderBy":"related","searchBy":"title","pageNo":3,"pageSize":10,"endDateTime":"","beginDateTime":"","filters":[],"configTenantId":2,"customFilter":{"operator":"and","properties":[],"filters":[{"operator":"or","properties":[]}]},"sign":"0de749c5-a61a-478e-888a-9ff5b0506f3d"}'
