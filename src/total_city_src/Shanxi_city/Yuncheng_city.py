...
if __name__ == '__main__':
    ...
    post_data = {'q': 'TITLE:学习考察 考察学习  ', 'fq': 'STATUS:4 AND DEL_FLAG:false  AND SITE_ID:1 AND -CHANNEL_ROOT: "辅助栏目"', 'fl': 'TITLE,CONTENT,CHANNEL_ROOT,SITE_ID,CHANNEL_PATH,CHANNEL_ID_PATH,MOD_TIME,STATUS,WRITE_TIME,SITE_NAME,URL,PIC_URL,ID,DOC_ID,SUMMARY,KIND,CHAN_ID,DEL_FLAG,KIND,DEPT_NAME,DOMAIN,URL2', 'start': '0', 'rows': '20', 'CHANNEL_ROOT': '', 'sort': 'score desc,SORT desc', 'facet': 'true', 'pageNum': '175', 'facet.mincount': '1', 'facet.limit': '10', 'facet.field': 'DEL_FLAG', 'hl': 'true', 'hl.fl': 'TITLE,CONTENT', 'hl.id': 'ID', 'hl.simple.pre': '<em>', 'hl.simple.post': '</em>', 'hl.maxAnalyzedChars': '-1', 'hl.fragsize': '120', 'hl.usePhraseHighlighter': 'true', 'hl.highlightMultiTerm': 'true'}
