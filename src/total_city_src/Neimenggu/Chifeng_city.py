...
if __name__ == '__main__':
    ...
    city_info = {
        ...
        'province_name': '内蒙古省',
        'province': 'Neimenggu',
        'base_url': 'http://www.chifeng.gov.cn/trs-search/trssearch/v2/searchAll.do?siteId=3&searchTag=all&allKeywords=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F+%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&fullKeywords=&orKeywords=&notKeywords=&sort=&position=1&organization=&pageNum={page_num}&pageSize=10&zcYear=&isAlways=1&fileTag=',
