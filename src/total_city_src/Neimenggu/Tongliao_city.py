...
if __name__ == '__main__':
    ...
    city_info = {
        ...
        'province_name': '内蒙古省',
        'province': 'Neimenggu',
        'base_url': 'https://www.tongliao.gov.cn/nmsearch/trssearch/searchAll.do?siteId=8&searchTag=all&allKeywords=%E5%AD%A6%E4%B9%A0%E8%80%83%E5%AF%9F%20%E8%80%83%E5%AF%9F%E5%AD%A6%E4%B9%A0&fullKeywords=&orKeywords=&notKeywords=&sort=&position=1&organization=&pageNum={page_num}&pageSize=10&zcYear=&isAlways=1&fileTag=&isAccurate=1',

        'total_news_num': 119,
        'each_page_news_num': 10,
    }

    headers = {"Accept":"application/json, text/plain, */*","Accept-Encoding":"gzip, deflate, br, zstd","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Connection":"keep-alive","Cookie":"JSESSIONID=295F93E4C90DDCEB19959EF0229ADCAB","Host":"www.tongliao.gov.cn","Referer":"https://www.tongliao.gov.cn/searchweb/","Sec-Fetch-Dest":"empty","Sec-Fetch-Mode":"cors","Sec-Fetch-Site":"same-origin","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0","sec-ch-ua":"\"Not/A)Brand\";v=\"8\", \"Chromium\";v=\"126\", \"Microsoft Edge\";v=\"126\"","sec-ch-ua-mobile":"?0","sec-ch-ua-platform":"\"Windows\""}
