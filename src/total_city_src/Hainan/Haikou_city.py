...
if __name__ == '__main__':
    ...
    post_data = '{"code":"17d1d69fedf","configCode":"","codes":"","searchWord":"考察学习 学习考察","historySearchWords":["考察学习 学习考察","考察学习","学习考察 考察学习"],"dataTypeId":"259","orderBy":"related","searchBy":"title","appendixType":"","granularity":"ALL","beginDateTime":"","endDateTime":"","isSearchForced":0,"filters":[],"pageNo":2,"pageSize":10}'
