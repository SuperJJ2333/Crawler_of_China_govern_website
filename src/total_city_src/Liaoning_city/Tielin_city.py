...
if __name__ == '__main__':
    ...
    post_data = {'qAnd': '', 'qOr': '', 'qAll': '', 'qNot': '', 'startTime': '', 'endTime': '', 'advSearch': '', 'originalSearchUrl': '/search/pcRender?pageId=b0827679e8314f909380e8f47211e958', 'originalSearch': '', 'app': '', 'searchArea': 'title', 'appName': '', 'sr': 'score desc', 'advtime': '', 'siteId': '', 'articleType': '', 'advrange': '', 'ext': '', 'pNo': '2', 'deviceType': 'pc', 'province': '', 'q2': '', 'q': '学习考察 考察学习'}
