...
if __name__ == '__main__':
    ...
    post_data = '{"tenantIds":"128","tenantId":"128","searchWord":"学习考察 考察学习","dataTypeId":4,"historySearchWords":[],"orderBy":"related","searchBy":"all","pageNo":"1","pageSize":10,"endDateTime":"","beginDateTime":"","filters":[],"configTenantId":"19","customFilter":{"operator":"and","properties":[],"filters":[]},"sign":"099d4c51-a7f9-452d-f51e-87c84a20164b"}'
