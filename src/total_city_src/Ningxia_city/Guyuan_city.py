...
if __name__ == '__main__':
    ...
    post_data = '{"tenantIds":"8","tenantId":"8","searchWord":"学习考察 考察学习","dataTypeId":4,"historySearchWords":[],"orderBy":"related","searchBy":"title","pageNo":"1","pageSize":10,"endDateTime":"","beginDateTime":"","filters":[],"configTenantId":"19","customFilter":{"operator":"and","properties":[],"filters":[]},"sign":"0f12cd4c-296f-4110-dec2-7f79acbde71e"}'
