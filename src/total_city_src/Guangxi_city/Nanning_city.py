...
if __name__ == '__main__':
    ...
    post_data = {'keyPlace': '1', 'sort': 'relevance', 'fileType': '', 'timeOption': '0',
                 'locationCode': '450000000000', 'siteCode': '4501000060', 'tab': 'all', 'page': '2', 'pageSize': '20',
                 'qt': '考察学习', 'ie': '59715e1d-8703-47df-83a5-5814ec517468'}
