...
if __name__ == '__main__':
    ...
    post_data = '{"code":"1890b3f6df9","configCode":"","codes":"","searchWord":"考察学习","historySearchWords":["学习考察","学习考察 考察学习"],"dataTypeId":"1","orderBy":"related","searchBy":"all","appendixType":"","granularity":"ALL","beginDateTime":"","endDateTime":"","isSearchForced":0,"filters":[],"pageNo":1,"pageSize":10}'
